...
public class LobbyCountdown extends Countdown{
	...
	public void startIdle() {
		isIdling = true;
		idleID = Bukkit.getScheduler().scheduleSyncRepeatingTask(gameStateManager.getPlugin(), () -> Bukkit.broadcastMessage(Main.PREFIX + "§7Bis zum Spielstart fehlen noch §6" +
								(LobbyState.MIN_PLAYERS - gameStateManager.getPlugin().getPlayers().size() + " Spieler§7.")), 0, 20 * IDLE_TIME);
	}
